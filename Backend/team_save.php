...
if (!$con) { die('Could not connect: ' . mysqli_error()); }
    ...
    //Creation
      ...
      $sql= "INSERT INTO bbbl.site_teams ( name, cyanide_id, coach_id, param_id_race, active, apothecary, assistantcoaches, cheerleaders, cash, rerolls, popularity, value, stadiumname, leitmotiv, logo, json)
