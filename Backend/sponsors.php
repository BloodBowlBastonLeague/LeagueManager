...
function sponsorsMatch_fetch($con, $competitionID){
    ...
    $sponsors = sponsorsMatch_fetch_sponsors($con, [$competition->sponsor_id_1,$competition->sponsor_id_2]);
...
function sponsorsMatch_fetch_sponsors($con, $ids){
    $sponsors=[];
