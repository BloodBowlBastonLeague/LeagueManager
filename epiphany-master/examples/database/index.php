...
EpiDatabase::employ('mysql','bbbl','localhost:3306','root','root');
 ...
 */
 ...
 function dbhandler()
 {
   $users = getDatabase()->all('SELECT * FROM membre');
 ...
 function teams()
 {
   $teams = getDatabase()->all('SELECT * FROM team');
