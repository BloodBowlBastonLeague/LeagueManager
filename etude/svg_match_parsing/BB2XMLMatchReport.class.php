...
class BB2XMLMatchReport {
    ...
    public function __construct($path) {
        ...
        $this->match['IdPlayerTypes'] = $match_result->getElementsByTagName('IdPlayerTypes')->item(0)->nodeValue;
         ...
         $this->match['Stadium>DarkElf'] = $match_result->getElementsByTagName('Stadium')->item(0)->nodeValue;
         ...
         $this->match['HomeValue000'] = $match_result->getElementsByTagName('HomeValue')->item(0)->nodeValue;
